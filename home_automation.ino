...
char pass[] = "XXXXXXXXXXX"; // replace with your password
...
void manual_control() {
  if (digitalRead(SwitchPin1) == LOW && SwitchState_1 == LOW) {
    ...
    if (Blynk.connected()) Blynk.virtualWrite(VPIN_BUTTON_1, HIGH);
    SwitchState_1 = HIGH;
    Serial.println("Switch-1 on");
  } else if (digitalRead(SwitchPin1) == HIGH && SwitchState_1 == HIGH) {
    toggleState_1 = LOW;
    digitalWrite(RelayPin1, HIGH);
    if (Blynk.connected()) Blynk.virtualWrite(VPIN_BUTTON_1, LOW);
    SwitchState_1 = LOW;
  ...
  if (digitalRead(SwitchPin2) == LOW && SwitchState_2 == LOW) {
    ...
    if (Blynk.connected()) Blynk.virtualWrite(VPIN_BUTTON_2, HIGH);
    SwitchState_2 = HIGH;
    Serial.println("Switch-2 on");
  } else if (digitalRead(SwitchPin2) == HIGH && SwitchState_2 == HIGH) {
    toggleState_2 = LOW;
    digitalWrite(RelayPin2, HIGH);
    if (Blynk.connected()) Blynk.virtualWrite(VPIN_BUTTON_2, LOW);
    SwitchState_2 = LOW;
  ...
  if (digitalRead(SwitchPin3) == LOW && SwitchState_3 == LOW) {
    ...
    if (Blynk.connected()) Blynk.virtualWrite(VPIN_BUTTON_3, HIGH);
    SwitchState_3 = HIGH;
    Serial.println("Switch-3 on");
  } else if (digitalRead(SwitchPin3) == HIGH && SwitchState_3 == HIGH) {
    toggleState_3 = LOW;
    digitalWrite(RelayPin3, HIGH);
    if (Blynk.connected()) Blynk.virtualWrite(VPIN_BUTTON_3, LOW);
    SwitchState_3 = LOW;
  ...
  if (digitalRead(SwitchPin4) == LOW && SwitchState_4 == LOW) {
    ...
    if (Blynk.connected()) Blynk.virtualWrite(VPIN_BUTTON_4, HIGH);
    SwitchState_4 = HIGH;
    Serial.println("Switch-4 on");
  } else if (digitalRead(SwitchPin4) == HIGH && SwitchState_4 == HIGH) {
    toggleState_4 = LOW;
    digitalWrite(RelayPin4, HIGH);
    if (Blynk.connected()) Blynk.virtualWrite(VPIN_BUTTON_4, LOW);
    SwitchState_4 = LOW;
...
void handleRoot() {
  ...
  html += "<link href=\"//cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css\" rel=\"stylesheet\">";
  html += "<style>";
  ...
  html += "<form action=\"/relay1\" method=\"POST\"><button type=\"submit\" class=\"cool-button btn\">Toggle Relay 1</button></form>";
  html += "<form action=\"/relay2\" method=\"POST\"><button type=\"submit\" class=\"cool-button btn\">Toggle Relay 2</button></form>";
  html += "<form action=\"/relay3\" method=\"POST\"><button type=\"submit\" class=\"cool-button btn\">Toggle Relay 3</button></form>";
  html += "<form action=\"/relay4\" method=\"POST\"><button type=\"submit\" class=\"cool-button btn\">Toggle Relay 4</button></form>";
  html += "</div>";
  html += "</div>";
  html += "</div>";
  html += "</div>";
  ...
  html += "<p class=\"copyright\">Copyright © 2024 <a href=\"https://anbusec.xyz\">anbuinfosec.</a></p>";
  html += "</div>";
  html += "<div class=\"col-md-6\">";
